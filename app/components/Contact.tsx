...
export default function Contact({
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // solo DOPO aver tentato la persistenza server-side del lead. Prima il redirect a WhatsApp
    // partiva in parallelo alla scrittura: se il tab veniva sostituito, il lead poteva perdersi.
    // opener=null: nessun reverse-tabnabbing.
