...
export default function Reviews() {
  ...
  // Il widget Trustindex è un embed di TERZE PARTI: si carica SOLO con consenso ai cookie
  // di misurazione. useConsent è reattivo → dopo "Accetta" compare senza reload.
    ...
    <section id="recensioni" className="relative bg-paper">
      ...
      <div className="relative mx-auto max-w-[1240px] px-5 py-24 sm:px-8 sm:py-32">
        ...
        {trustindexReady ? (
          ...
          // Loader configurato ma consenso non ancora dato: fallback onesto — niente embed,
