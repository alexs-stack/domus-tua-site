...
const copy = {
  it: {
    ...
    squadraTrioAlt: "Foto di gruppo Domus Tua in studio",
    squadraRedAlt: "Foto di gruppo Domus Tua in blazer rosso, nella sede",
  ...
  en: {
    ...
    squadraTrioAlt: "Domus Tua group photo in the studio",
    squadraRedAlt: "Domus Tua group photo in red blazers, at the office",
  ...
  fr: {
    ...
    squadraTrioAlt: "Photo de groupe Domus Tua en studio",
    squadraRedAlt: "Photo de groupe Domus Tua en blazer rouge, à l’agence",
  ...
  de: {
    ...
    squadraTrioAlt: "Gruppenfoto von Domus Tua im Studio",
    squadraRedAlt: "Gruppenfoto von Domus Tua in roten Blazern, im Büro",
  ...
  es: {
    ...
    squadraTrioAlt: "Foto de grupo de Domus Tua en el estudio",
    squadraRedAlt: "Foto de grupo de Domus Tua con blazer rojo, en la oficina",
