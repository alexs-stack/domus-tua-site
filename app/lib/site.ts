...
export const site = {
  ...
  rating: "4.9",
  reviewsCount: "531",
  // Nota: il conteggio video numerico ("440+") è stato RIMOSSO perché non verificato. Il canale
  // YouTube (@DOMUSTUASRLIMMOBILIARE) racconta con video reali senza dichiarare un numero non
  // provato. Se un domani il cliente conferma il conteggio esatto, reintrodurre qui una metrica
  // verificata.
