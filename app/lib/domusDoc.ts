...
const NEUTRAL: Record<DocLocale, Omit<DomusDocSafetyCopy, "eyebrow" | "linkLabel">> = {
  it: {
    ...
    text: "Con Domus D.O.C. controlliamo documenti, conformità e trasparenza prima di portare una casa sul mercato: è il metodo con cui seguiamo ogni incarico, per arrivare al rogito senza sorprese. Quali verifiche siano già state fatte su questo immobile te lo conferma il team.",
  ...
  en: {
    ...
    text: "With Domus D.O.C. we check documents, compliance and transparency before a home reaches the market: it's the method we follow on every mandate, to reach completion without surprises. Which checks have already been done on this property is something the team confirms with you.",
    points: ["Document check", "Compliance review", "Transparency before the viewing"],
  },
  fr: {
    title: "Domus D.O.C., notre méthode sur les documents",
    text: "Avec Domus D.O.C. nous contrôlons documents, conformité et transparence avant de mettre un bien sur le marché : c'est la méthode que nous suivons pour chaque mandat, pour arriver à la vente sans surprises. Les vérifications déjà effectuées sur ce bien, c'est l'équipe qui vous les confirme.",
  ...
  de: {
    ...
    text: "Mit Domus D.O.C. prüfen wir Unterlagen, Konformität und Transparenz, bevor eine Immobilie auf den Markt kommt: Es ist die Methode, der wir bei jedem Auftrag folgen, um ohne Überraschungen zum Abschluss zu kommen. Welche Prüfungen bei dieser Immobilie bereits erfolgt sind, bestätigt Ihnen das Team.",
  ...
  es: {
    ...
    text: "Con Domus D.O.C. comprobamos documentos, conformidad y transparencia antes de llevar una casa al mercado: es el método que seguimos en cada encargo, para llegar a la venta sin sorpresas. Qué comprobaciones ya se han hecho en esta propiedad te lo confirma el equipo.",
...
const VERIFIED: Record<DocLocale, Omit<DomusDocSafetyCopy, "eyebrow" | "linkLabel">> = {
  it: {
    ...
    text: "Questo immobile segue il protocollo Domus di Origine Certificata: documenti, conformità e trasparenza controllati prima della vendita. Così visiti e scegli con serenità, senza sorprese.",
  ...
  en: {
    ...
    text: "This property follows the Domus of Certified Origin protocol: documents, compliance and transparency checked before the sale. So you view and choose with peace of mind, no surprises.",
    points: ["Documents in order", "Compliance checked", "Pre-visit transparency"],
  },
  fr: {
    title: "Un logement vérifié, avant même d’entrer.",
    text: "Ce bien suit le protocole Domus d’Origine Certifiée : documents, conformité et transparence contrôlés avant la vente. Vous visitez et choisissez en toute sérénité, sans surprises.",
  ...
  de: {
    ...
    text: "Diese Immobilie folgt dem Protokoll Domus di Origine Certificata: Unterlagen, Konformität und Transparenz werden vor dem Verkauf geprüft. So besichtigen und entscheiden Sie mit Ruhe, ohne Überraschungen.",
  ...
  es: {
    ...
    text: "Esta propiedad sigue el protocolo Domus di Origine Certificata: documentos, conformidad y transparencia comprobados antes de la venta. Así visitas y eliges con tranquilidad, sin sorpresas.",
