...
export const dictionaries: Record<Locale, Dict> = {
  ...
  es: {
    ...
    search: {
      ...
      nlPlaceholder: "Ej. piso de tres ambientes con jardín en Tradate por menos de 300.000 €",
      nlTeaser: "Búsqueda inteligente muy pronto",
      nlHint: "Pronto podrás buscar como nos hablarías. Mientras tanto, usa los filtros.",
      contract: "Contrato", type: "Tipo", zone: "Zona", budget: "Presupuesto", rooms: "Ambientes", features: "Características",
      ...
      emptyCopy: "¿No está online? Podría llegar. Cuéntanos qué buscas: muchas casas las encontramos nosotros.",
