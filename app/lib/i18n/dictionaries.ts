...
type Dict = {
  nav: { vendi: string; acquista: string; metodo: string; openDomus: string; case: string; recensioni: string; chiSiamo: string; lavora: string; contatti: string; percorso: string };
  ...
  whatsapp: { cta: string };
  footer: { naviga: string; orari: string; monFri: string; sat: string; sun: string; onAppt: string; valuta: string; privacy: string; cookie: string; contatti: string; lavora: string };
  lang: { label: string };
};

export const dictionaries: Record<Locale, Dict> = {
  it: {
    nav: { vendi: "Vendi", acquista: "Acquista", metodo: "Metodo Domus", openDomus: "Open Domus", case: "Case", recensioni: "Recensioni", chiSiamo: "Chi siamo", lavora: "Lavora con noi", contatti: "Contatti", percorso: "Percorso" },
    ...
    footer: { naviga: "Naviga", orari: "Orari", monFri: "Lun – Ven", sat: "Sabato", sun: "Domenica", onAppt: "Su appuntamento", valuta: "Valuta la tua casa", privacy: "Privacy", cookie: "Cookie", contatti: "Contatti", lavora: "Lavora con noi" },
    lang: { label: "Lingua" },
  },
  en: {
    nav: { vendi: "Sell", acquista: "Buy", metodo: "The Method", openDomus: "Open Domus", case: "Homes", recensioni: "Reviews", chiSiamo: "About us", lavora: "Work with us", contatti: "Contact", percorso: "Journey" },
    ...
    footer: { naviga: "Navigate", orari: "Opening hours", monFri: "Mon – Fri", sat: "Saturday", sun: "Sunday", onAppt: "By appointment", valuta: "Value your home", privacy: "Privacy", cookie: "Cookies", contatti: "Contact", lavora: "Work with us" },
    lang: { label: "Language" },
  },
  fr: {
    nav: { vendi: "Vendre", acquista: "Acheter", metodo: "La Méthode", openDomus: "Open Domus", case: "Biens", recensioni: "Avis", chiSiamo: "À propos", lavora: "Rejoignez-nous", contatti: "Contact", percorso: "Parcours" },
    ...
    footer: { naviga: "Navigation", orari: "Horaires", monFri: "Lun – Ven", sat: "Samedi", sun: "Dimanche", onAppt: "Sur rendez-vous", valuta: "Estimez votre bien", privacy: "Confidentialité", cookie: "Cookies", contatti: "Contact", lavora: "Rejoignez-nous" },
    lang: { label: "Langue" },
  },
  de: {
    nav: { vendi: "Verkaufen", acquista: "Kaufen", metodo: "Die Methode", openDomus: "Open Domus", case: "Immobilien", recensioni: "Bewertungen", chiSiamo: "Über uns", lavora: "Karriere", contatti: "Kontakt", percorso: "Ablauf" },
    ...
    footer: { naviga: "Navigation", orari: "Öffnungszeiten", monFri: "Mo – Fr", sat: "Samstag", sun: "Sonntag", onAppt: "Nach Vereinbarung", valuta: "Immobilie bewerten", privacy: "Datenschutz", cookie: "Cookies", contatti: "Kontakt", lavora: "Arbeiten Sie mit uns" },
    lang: { label: "Sprache" },
  },
  es: {
    nav: { vendi: "Vender", acquista: "Comprar", metodo: "El Método", openDomus: "Open Domus", case: "Inmuebles", recensioni: "Reseñas", chiSiamo: "Quiénes somos", lavora: "Únete al equipo", contatti: "Contacto", percorso: "Recorrido" },
    ...
    footer: { naviga: "Navegar", orari: "Horario", monFri: "Lun – Vie", sat: "Sábado", sun: "Domingo", onAppt: "Con cita previa", valuta: "Valora tu casa", privacy: "Privacidad", cookie: "Cookies", contatti: "Contacto", lavora: "Trabaja con nosotras" },
    lang: { label: "Idioma" },
  },
};
