...
| `--color-ink` / graphite / stone | invariati | invariati il 10 settembre; dall'11 `--color-ink` = `--color-graphite` = `--foreground` = **#46423d** (prima ink #1a1816: «NIENTE SCRITTE BLACK», Alberto, 09aff4b); stone #625d56 | testo; ink solo come colore di testo |
...
| A49 | 2026-09-22, screenshot dell'hero | «ma sopratutto la hero e il preloader, stesso discorso di prima ma qua ancora peggio. non c'è ne l'immagine alta che fa da sfondo pagina a schermo intero, ne l'effetto dello scroll dentro l'immagine perchè lhai tagliata a metà e bloccato lo scroll della pagina per l'effetto zoom» | **Applicata** (commit 52fad5e del 22 set. 2026, notte): via il corridoio del tuffo (useCorridor, zoom, lift, il foglio di Posizionamento, il marcatore da 1 px); `HeroCinematic.tsx` è la testa di era senza blocco: la foto alta (`hero-raffaela-piscina-alta-cielo.webp`, 2:3 2560×3812, cielo.mjs; la striscia 9:16 per il telefono da hero-piscina.mjs; misure in hero.json, quote in hero.ts) in flusso e intera; la salita a riposo fino alla piega dove comincia il blocco (D-A49-1); da lg il blocco bianco (A70) sul portico a destra di Raffaela — la banda scura misurata, l'acqua è chiara (D-A49-2) — e il lockup con la firma sull'acqua fino a 0,85 (D-A49-3), poi la cartolina di A53 con la firma del capitolo dtCartolina/0,9 (D-A49-6: D18 non vale fra hero e cartolina, `MOTIVO_COMUNE` in chapters.test); il rito delle lettere suona alla prima entrata in scena (D-A49-5); sotto lg la striscia 9:16, il lockup sull'acqua e il blocco dopo la foto in inchiostro (D-A49-4). Test: hero-alto.test/spec al posto di hero-dive; corridors senza `hero`. Da mostrare: la piega a riposo (cielo-carta nel primo schermo), il blocco a destra, il lockup a 0,68-0,85 invece che sul bordo. | transcript 2026-09-22 |
...
| A51 | 2026-09-22 | «inoltre il colore di sfondo della pagina che dovrebbe essere avorio, è ancora troppo chiaro, rendilo lievemente sul rosso rosa, tipo tramonto ma opaco e piu chiaro di un tramonto» | **Applicata** (commit 8fe368e, poi 423c188 col rosa pesca e la chiusura della finestra, 22 set., pomeriggio, dopo «lo sfondo è ancora bianco, quando avevamo detto di metterlo sul rosa tramonto»): la carta passa da #f9f5ef a #f6d9d0 (rosa pesca opaco, chiaro; il primo passo, #f9ede8, era troppo timido: Alberto, subito dopo, «manca ancora lo sfondo del colore, lo sfondo è ancora bianco»; il secondo, #f9e6e0, «è ancora troppo bianco»: col rosa pesca gli occhielli, i testi piccoli in rosso (etichette e link a 16 px, corpi, numeri) e il bottone a testo rosso passano al rosso cupo #a30707, e la pietra a #625d56, perché il rosso vivo e la pietra di prima scendevano sotto 4,5:1; titoli, «Tua», corsivi e bottoni pieni restano nel rosso vivo) e con lei avorio profondo #f2cfc5, carta chiara #fdf1ec e filo #e9c9c0; `themeColor`, tinte.mjs/cielo.mjs/foto-alte.mjs, tinte.json rigenerato, il sidecar di impeccable e i test allineati; inchiostro 7,3:1, rosso cupo degli occhielli 6,1:1 e pietra 5:1 sul nuovo fondo. Da mostrare: la tinta. | transcript 2026-09-22 |
...
| A56 | 2026-09-22, pomeriggio, mentre guardava il dev server | «le scritte bianche sopra le immagini, mettile di colore grigio, come quello della hero della scritta "domus"» | **Applicata** (commit 8fe368e e 423c188, con A51): le sezioni sopra le foto delle teste (A48/A54) e il capitolo sulla facciata della finestra (A47) sono nel grigio del lockup, `--color-graphite`, senza ombra (ink-media.test torna alle due occorrenze di D80); le utility di colore dentro cedono al grigio, segnaposto e righe lo portano attenuato con color-mix. Supera il bianco di A48/A54 e la voce 29 del foglio. | transcript 2026-09-22 |
| A57 | 2026-09-22, sera, con due screenshot a 1902 px (la facciata a schermo intero con la cima delle terrazze a ~100 px dal bordo alto; il titolo «DOMUS» da solo sulla carta, cioè lo stato delle tende) | «aggiungere lo stesso effetto di scroll orizzontale con gsap e animazione entrata immagine come in "Tra la Pineta e Milano" nella sezione Open domus della home, all'altezza dello screenshot allegato» | **Applicata** (commit 8e5c633 del 22 set., sera): la finestra è un `HorizonScroller` (`#open-domus`, `data-corridor="finestra"`) con tre pannelli di 100vw — la facciata 9:16 intera col titolo sul cielo-carta; il claim del format col video di Teresa a sipario; le due liste con la CTA e Raffaela sulla soglia (`raffaela-porta-alta.jpg`, 2:3, alta 80svh) a sipario — e la SALITA (`lead`, prop nuova di HorizonScroller): la cornice sale dentro lo schermo agganciato di `cima × altezza − 0,1 × vh` px (finestra.ts `leadDistance`), cioè fino alla posa dello screenshot, poi il track scorre di lato e la foto esce a sinistra. La firma resta quella del capitolo (dtInOut, scrub 0,15: D18 vieta di copiare ease e scrub di storia); i sipari sono quelli del nastro (dtOut 1,6 s, scala 1,15→1). Rete di fuoco del nastro: il Tab su un pannello fuori scena porta la pagina alla quota giusta invertendo l'ease (vale anche per storia). Sotto la soglia: tre pannelli in colonna, foto intera. | transcript 2026-09-22 |
| A58 | 2026-09-22, sera | «togli l'animazione dell'immagine di open domus all'entrata, mantieni la stessa posizione ma lasciala a schermo intero da subito, (non serve neanche l'animazione di uscita che si chiude, perché con il punto 5 con lo scroll orizzontale andando verso destra usciamo dalla foto)» | **Applicata** con A57: morti le tende e i montanti di era (SHUTTER_L/R, PHONE_CLIP), lo stage .75→1, la pista di 200svh, i marcatori da 1 px `.dt-od_mark`, lo spazio sopra del capitolo sulla foto (A47/A48/A54/A56 sulla finestra: `--dt-od-sopra`, `.dt-od_content`) e la chiusura in cartolina (A53 sulla finestra; ChiusuraFoto resta alle teste). La foto è a schermo intero da subito, in flusso, come le teste (A45). Supera A47 (il capitolo sulla foto), A53 sulla finestra e la parte di spec §3.10 sulle tende. | transcript 2026-09-22 |
| A59 | 2026-09-22, sera | «aggiungere animazione e rendere piu bella la sezione "D.O.C. … Domus di Origine Certificata …" della home, mettendo piu foto» | **Applicata**: il foglio delle foto (DomusDocProtocol, home e /vendi, /acquista, /metodo): i pilastri in colonna a sinistra; a destra una cornice sticky (da lg, top 10svh, mai più alta di 80svh) con cinque foto, una per pilastro (`attico-studio-alta`, `villa-ingresso-scala-alta`, `raffaela-salotto-alta`, `villa-salotto-doppio`, `raffaela-portico-alta`), che sfoglia col pilastro attivo (quello che attraversa il 62 % dello schermo): tendina dal basso (dall'alto risalendo) e scala 1,08→1 in 1,1 s dtOut (tratto «sfoglio» nel registro), e la cornice prende l'altezza del sorgente: nessun taglio; il trattino del pilastro attivo cresce verso il margine, gli altri scendono in pietra; il sigillo è un anello di testo a 16 px che gira in senso orario (24 s). Sotto lg la cornice sta sopra la lista, in flusso; con reduced-motion resta la prima foto, ferma. Foto e gesto sono scelte mie (D-A59). È una quarta cosa sticky oltre i tre nastri: deroga dichiarata a DESIGN.md, da mostrare. | transcript 2026-09-22 |
| A60 | 2026-09-22, sera, col file «🎬 STORIE DI SUCCESSO _ Villa di Roberta Venduta al primo OPEN DOMUS ⭐️ … _1080p.mp4» in Downloads | «ho scaricato il video … di Villa di Roberta, venduta al primo Open Domus, mettilo al posto della preview youtube. con la logica di audio che si attiva in automatico, e quando esci dalla sezione scrollando la pagina, si disattiva» | **Applicata**: `StoryVideo` in «Perché Domus Tua» (Storie vere) al posto della facciata YouTube dello stesso video; file transcodificati con ffmpeg in `public/media/open-domus-roberta-{1080,720}.{mp4,webm}` (H.264 crf 26/27, VP9 crf 36/38: 26, 13, 24 e 12,5 MB) più il poster del primo fotogramma; `useAmbientVideo` con `audio: true` (la logica di A44 del Congedo: prova col suono in vista, se il browser lo nega parte muto e si accende al primo gesto; fuori vista si ferma), anche sul telefono, sd/hd scelti dal rapporto 9:16 (`ar` e `sdWidth` in ambient.ts); due comandi da 56 px (pausa, audio); chi toglie l'audio lo tiene tolto. Il tetto a 420 px della colonna è tolto (era il conto della copertina YouTube 16:9). Lettura mia: «la preview youtube» è quella dello stesso video in Storie vere; il video di Teresa resta nel nastro di Open Domus (se intendeva quello, è uno spostamento breve). | transcript 2026-09-22 |
| A61 | 2026-09-22, sera | «dobbiamo cambiare le immagini di Prima, le persone … Poi, le immagini … Infine, il rogito …, nella prima sempre una foto di raffaela, magari quelle allo specchio, e le altre scegli tu» | **Applicata** (Method.tsx, home e /metodo): atto 1 `raffaela-specchio-riflesso.jpg` (3:4, di spalle col riflesso che guarda chi legge; `-sorriso` è nella rotaia del team e `-profilo` in Percorsi), atto 2 `villa-salotto-doppio.jpg` (3:2), atto 3 `raffaela-chiavi-alta.jpg` (2:3; via `handshake.jpg` col play cotto nei pixel, resta il link al video); le scatole prendono il rapporto del sorgente (stile inline su ClipMedia), alt riscritti nelle cinque lingue. | transcript 2026-09-22 |
| A62 | 2026-09-22, sera | «mandami il percorso di dove sono tutti i media, così a fine lavoro posso dirti quale immagine sostituire con cosa, e quali togliere e aggiungere nel sito» | **Applicata**: `docs/media/inventario-2026-09-22.md` (file, misure, rapporto, peso, dove è montato) e `docs/media/inventario-2026-09-22.html` (foglio di contatto, si apre dal disco), scritti da `scripts/.probe/inventario.mjs`; radice `C:\Users\alber\domus-tua-site\public\` (`media/`, `images/`, `images/reali/`, `images/reali/video/`): 121 file, 24 non montati. | transcript 2026-09-22 |
| A63 | 2026-09-22, sera, dopo aver visto 8e5c633 sul dev | «rimpicciolisci il video villa di roberta di poco» | **Applicata**: la colonna del video di Roberta scende da 42vw/640 px a 36vw/560 px (518 px a 1440). | transcript 2026-09-22 |
| A64 | 2026-09-22, sera | «distanzia di più i pilastri del punto 6, in modo che le foto che si sfogliano serve un po' più di scroll. al momento è troppo veloce e non si fa in tempo a vedere quella successiva che parte subito lo sfoglio della successiva» | **Applicata**: i pilastri di D.O.C. hanno passo doppio (py-12) e la riga per chi vende in misura lead: ~220 px di scroll a 1440 fra uno sfoglio e l'altro (erano ~130). | transcript 2026-09-22 |
| A65 | 2026-09-22, sera, con lo screenshot del titolo «OPEN DOMUS» solo sulla carta | «quando arriviamo a sto punto esatto dello screenshot allegato, vorrei che si bloccasse sticky la scritta e salisse un po' l'immagine, fino a coprire da sotto le lettere circa di Open domus con il tetto della casa a scala, una volta arrivata lì, si sblocca e parte lo scroll orizzontale» | **Applicata**: la salita muove solo la scatola della foto (`.dt-od_window`), il titolo resta fermo nella cornice e il tetto delle terrazze gli passa dietro finché non arriva a metà delle lettere (`FINESTRA.copri` 0,5 dell'altezza del titolo; finestra.ts `leadDistance`); poi il nastro. | transcript 2026-09-22 |
| A66 | 2026-09-22, sera, con lo screenshot del terzo pannello | «nello scroll orizzontale le scritte sono troppo piccole, rendile grandi e animate come nell'altro scroll orizzontale della hero, dove le scritte si muovono e vanno sopra la foto o dietro» | **Applicata**: nel secondo pannello il claim è in d2 per lettera e l'intro in misura lead; nel terzo un titolo a gradini («Per chi vende / e per chi / compra», tre righe come «Tra la Pineta e Milano», `data-horizon-stair` in parallasse contraria) posato sulla foto della coda, con le due liste in misura lead e il rilancio. | transcript 2026-09-22 |
| A67 | 2026-09-22, sera; poi «per il punto 5 vorrei che usassi questa villa-piscina-lunga-alta-cielo.webp» | «al posto dell'immagine di raffaela nello scroll orizzontale seconda sezione, vorrei un'altra immagine no bg, in modo che si arriva da destra e poi si scende giù con lo scroll normale sull'immagine» | **Applicata**: il terzo pannello è la CODA: la piscina lunga no-bg (coda.json da finestra.mjs: cima 0,267, bande del segno 0,438-0,667 e 0,766-1) a tutta larghezza col rapporto del sorgente, arrivata da destra col sipario e già alzata (il soggetto al 55 % dello schermo, `FINESTRA.codaSopra`; sopra, sulla carta, le scritte); finito il track la foto e le scritte scendono 1:1 con lo scroll (`tail` di HorizonScroller, `codaFrom`/`codaDistance`) finché il fondo della foto non tocca il fondo dello schermo, e lì la sezione finisce. Con salita e coda la sezione è alta salita + corsa + coda + schermo e il track corre 1:1 (`top+=salita top` → `top+=salita+corsa top`). Raffaela sulla soglia (`raffaela-porta-alta.jpg`) torna di riserva. | transcript 2026-09-22 |
| A68 | 2026-09-22, sera, a lavoro in corso | «nel punto 5 aggiungi che all'uscita (come nelle altre foto lunga alta), si chiudesse con l'animazione» | **Applicata**: finita la coda, dallo sgancio dello schermo finché il fondo della sezione non arriva al 10 % del viewport, la scatola della piscina si ritira nella cornice della cartolina (8/22, `CORNICE_LG` di ChiusuraFoto, ease dtCartolina, scrub 0,9), la meccanica del Congedo e delle teste; solo col nastro. | transcript 2026-09-22 |
| A69 | 2026-09-22, sera, alle domande di fine giro | «salotto doppio non mi piace, usa questa: villa-piscina-facciata.jpg» | **Applicata**: `villa-piscina-facciata.jpg` (3:2) nell'atto «Poi, le immagini» del Metodo; in D.O.C. «Preparazione» la terrazza sulle colline (`villa-terrazza-colline-alta.jpg`, generata). I 21 file non montati restano nel repo («lasciali nel repo»). | transcript 2026-09-22 |
| A70 | 2026-09-22, sera | sul grigio che perde sulle bande scure delle teste: «prova a farle più grandi e grosse e bianche, poi lo testo e se non si leggono abbassiamo la luminosità dell'immagine» | **Applicata** (da testare da Alberto): sulle teste con `data-sopra="foto"` le scritte sono bianche senza ombra, titoli ×1,2, corpo a d4 con peso 500, link e occhielli a 600. Supera A56 sulle teste. Il passo dopo, se non leggono, è la luminosità della foto. | transcript 2026-09-22 |
| A71 | 2026-09-22, sera | su A49: «sì, fallo, anche il voto e i due link. prova a vedere se riesci a fare un upscale se ho crediti, sennò fa niente, e falla no-bg così è più bella»; su /servizi e /domande-frequenti: «vanno bene così»; sul video di Roberta in Storie vere: «va bene così» | **Applicata** con A49 (stesso commit): outpaint 2:3 (job 453a6ceb, 2 crediti) + upscale 4K (2 crediti) e cielo trasparente fatti la sera del 22; il voto e i due link stanno nel blocco bianco sulla foto. /servizi, /domande-frequenti e la lettura di A60 sono chiusi. Crediti Higgsfield: 5. |
| A73 | 2026-09-22, notte, vedendo l'hero alto sul dev | «la foto della hero va modificata, usa Higgsfield per togliere il bg (ha qualche problema), e mettere la foto di Raffaela (attualmente è irriconoscibile perché modificata da Higgsfield). Usa quella del preloader. È come se dobbiamo photoshoppare la foto aggiungendo perfettamente la sagoma mascherata di Raffaela nella foto al posto di quella attuale. Proviamo con Higgsfield se fa. Non devono cambiare né rapporti, grandezza, né qualità» | **Applicata** (commit 99595cc, 22 set. 2026, notte): un fotoritocco, non una generazione (`scripts/media/hero-raffaela.mjs`): Higgsfield ha fatto solo il PLATE (gpt_image_2_5, «remove the woman», 2k, 3 crediti: job ef80fd4b), allineato e usato solo nelle schegge della figura alterata che la figura nuova non copre; la Raffaela del preloader (`raffaela-sagoma.png`, il ritaglio vero in pizzo) è posata a scala e posizione della figura vecchia (testa→ginocchio 352 px), sotto restano i pantaloni e le scarpe della foto; la JPEG resta 2560×3812 (ricodifica q92 4:4:4). Il «problema del bg» era la tasca di cielo pallido fra le fronde dell'albero a destra: cielo.mjs la libera con `raggio 700`, `libere 0,42` e il nuovo `pallido` (nessun credito di Higgsfield per lo sfondo). hero.json e la striscia 9:16 rigenerati (cima 0,194; `--dt-hero-cima`). Crediti Higgsfield: 2. Corretta da A74 (sotto). | transcript 2026-09-22 |
| A74 | 2026-09-22, notte, vedendo il montaggio di A73 (la sagoma del preloader, tagliata alle ginocchia, sui pantaloni della foto) | «ma scusa, abbiamo fatto la foto con Higgsfield senza Raffaela apposta per poi attaccarla sopra, perché l'hai messa nella foto vecchia? Se non ha le gambe quella del preloader, metti questa» (il PNG intero, `spc_wjZ3m6DIQ5P93KACB_N0MGJTF9.png`, 2560×3816 con l'alpha: la figura con le gambe e le scarpe) | **Applicata** (commit f2e5408, 22 set. 2026, notte): `hero-raffaela.mjs` riscritto — il plate allineato copre TUTTA la figura vecchia (dai capelli alle scarpe, rettangolo 1200-1560 × 1810-2370, maschera differenza/plate chiusa e dilatata, 97.211 px) e sopra posa il ritaglio intero di Alberto (`Downloads/higgsfield/raffaela-intera.png`) riscalato all'altezza della figura vecchia (1833→2352, scala 0,2383) coi piedi sul punto in cui stavano i suoi (gambe a x 1325). Perché non il plate come base: è un render 2k (1360×2048), ingrandirlo di 1,9 volte perderebbe la qualità che A73 vieta di perdere; la base resta la foto a 2560×3812. cielo.webp, striscia 9:16 e hero.json rigenerati. Nessun credito speso (restano 2). | transcript 2026-09-22 |
| A72 | 2026-09-22, notte, nel prompt del blocco 2 | «togliamo il video della piscina, e mettiamo un'altra immagine no-bg alta: villa-facciata-piscina-alta-cielo.webp, stesso stile e animazione dello sticky scroll che poi diventa scroll orizzontale, ed entra la sezione di Carmine e Seguici» (occhiello, lead e rilancio: «decidi tu se restano sopra il nastro sulla carta o posano sulla foto in bianco (A70), e dichiaralo»; coda: «se vuoi una coda che scende 1:1 come la piscina di Open Domus, usa tail e la chiusura in cartolina, altrimenti il nastro finisce lì») | **Applicata** (commit aa2953d, 22 set. 2026, notte): `CostiChiari nastro` monta `HorizonScroller` (`#costi`, `data-corridor="costi"`) con quattro pannelli — la facciata (costi.json da `finestra.mjs villa-facciata-piscina-alta`: cima 0,219, bande 0,253-0,374, 0,411-0,694, 0,759-1) col solo TITOLO in inchiostro sul cielo, a destra, per lettera a 7,5vw (D-A72-1, rivista la stessa notte dopo «non c'è lo sticky scroll che fa salire un po' l'immagine» e «le scritte e i bottoni sono troppo piccole e non animate, gestisci gli spazi e le animazioni di entrata»: prima la riga intera stava sul cielo e la salita si fermava al piede della riga, 137 px a 1440 e 0 a 1024), l'ARRIVO di A65 (`costi.ts`: il tetto piatto sotto il titolo, `cimaTitolo` 0,332, sale fino a metà delle lettere: ≈ 450 px a 1440×900, ≈ 300 a 1024×768); il CLAIM dei costi (occhiello, la prima frase del lead in d2 per lettera, il resto in misura lead, le righe del mandato, il rilancio pieno `cta-solid lg`); Carmine (`FeaturedTestimonial panel`, sipario + la foto che affonda agganciata al track: `useHorizonTrack`, il canale del track nuovo di HorizonScroller); Seguici (`Social`, titolo per lettera a 5,2vw, congedo allo sgancio). Firma nuova (D18): dtTappe, una curva a due soste (claim e Carmine al centro dello schermo; dista 0,149 dalla curva più vicina, dtSosta) e scrub `true` — la prima, dtPosa `0.6,0,0.2,1` in-out, correva sui pannelli coi contenuti (Carmine intero per il 2,5 % della corsa, ora 17,4 %); il claim è un pannello di 60vw; sotto la soglia la foto sale sotto il titolo (−30vw); le icone di Seguici nel nastro a 56 px e il rilancio di Carmine a contorno grande; e, di passaggio, la colonna di D.O.C. sul telefono non sborda più (`grid-cols-[minmax(0,1fr)]`: la cornice 2:3 con l'altezza della foto 9:16 di A69 chiedeva 421 px a 390); `testimonianza` e `social` restano coi loro ease/scrub e inneschi nuovi. D-A72-3: niente coda né cartolina. L'acqua è uscita dal codice (media.ts, CostiChiari, test), i file restano. Corridoi della home: sei (`EXPECTED_HOME` + `costi`). | transcript 2026-09-22 | transcript 2026-09-22 |
| A75 | 2026-09-22, notte, con gli screenshot della galleria di era | «dobbiamo rendere l'entrata tra il preloader e la hero cinematografica e immersive … prima c'è l'animazione della scritta Domus Tua, al centro, e la firma sotto (la casa della foto in questo momento non si deve vedere, quindi deve stare in basso fuori dalla prospettiva), subito dopo la foto risale su dal basso con la curva dell'animazione smooth, fino a dove Raffaela dell'immagine entra nella prospettiva» | **Applicata** (commit A75-A79, hash nel handoff): `data-hero-entrata` dal boot script solo col sipario sulla home; il lockup d'entrata (`.dt-hero_entrata`, aria-hidden, lettere coi ruoli title/accent in CSS) al centro della banda dietro lo strato; la foto parte col tetto 4svh sotto lo schermo e sale con domus.inOut in 2,1 s a +2,2 s dall'handoff (`ENTRATA` di hero.ts, @keyframes `dt-hero-sale`, compositor); il lockup risale di 55svh e sfuma. D-A75-1: la salita a riposo porta Raffaela intera nel primo schermo (suole a 6svh dal fondo), supera D-A49-1; D-A75-2: il riquadro con flow-root ritaglia la foto al bordo della testata (logo e menu non stanno sulla villa). HeroCinematic toglie l'attributo a salita finita e chiede il refresh a ScrollTrigger. |
| A76 | 2026-09-22, notte, stesso messaggio; poi «non deve essere con le freccette, ma automatico dopo un secondo», «togli anche i numeri», «no, non mettere il bottone», «l'animazione è perfetta» | «effetti slide sulle 2 foto della sezione Vendere senza stress … e tra la pineta e Milano: fare un effetto di slide automatico una sopra l'altra, come in era residence» | **Applicata**: `FotoSlide.tsx`, foto impilate nella scatola del sipario del nastro, la successiva entra da destra con un clip a poligono inclinato di 10 punti (dtInOut, 1,4 s) dopo 1 s di sosta, in giro; nessun controllo (frecce, numeri e bottone tolti su richiesta: il giro non soddisfa WCAG 2.2.2, scelta di Alberto dichiarata); si ferma solo fuori vista o a scheda nascosta; reduced-motion e senza JS: la prima foto ferma. Foto nuove senza persone: vetrata con lanterne, terrazze col glicine; uliveto, villa dall'acqua (alt in cinque lingue). |
| A77 | 2026-09-22, notte | «ora fai la stessa cosa anche per questa sezione, con le preview di YouTube» (il pannello del format di Open Domus) | **Applicata**: le facciate di YouTube (Teresa col suo poster e le tre video recensioni con la copertina del canale) scorrono in FotoSlide come le foto; un clic sul play ferma il giro su quel video. Anche su /metodo e /open-domus, dove il capitolo monta lo stesso video. |
| A78 | 2026-09-22, notte | «la scritta Open Domus deve essere animata dal centro verso l'esterno, con GSAP, come se uscisse dal centro e si allargasse verso sinistra e destra» | **Applicata**: l'h2 della finestra spezzato con SplitChars; quando la cima della cornice passa il 75 % dello schermo la scritta si apre dal centro (clip a poligono) e le lettere, raccolte al centro, scivolano ai loro posti (expo.out 1,6 s, stagger dal centro); si riarma uscendo sotto lo schermo. |
| A79 | 2026-09-22, notte, con gli screenshot del fondo dell'hero e della piscina della coda | «a questa altezza si deve chiudere/rimpicciolire prima, attualmente si chiude troppo in fondo e non si nota neanche quando scrolli»; «stessa cosa qua, a questa altezza dell'immagine» | **Applicata**: la cartolina dell'hero corre col fondo della foto dal 130 % al 35 % del viewport (`CHIUSURA` di hero.ts, prop `fondo` di ChiusuraFoto; chapters.hero aggiornato); quella della coda di Open Domus col fondo della sezione dal 230 % al 70 % (prima dallo sgancio al 10 %). |
| A80 | 2026-09-23 | «dobbiamo risolvere la pagina acquista, la ricerca intelligence nn si vede . abbassiamo la luminosità della foto sotto , oppure ingegnati e stupiscimi cambiando il design dell'input della ricerca , con qualcosa di figo e bello e consono al design del sito» | **Applicata** (branch `claude/acquista-ricerca`): misurato su produzione, la ricerca bianca cadeva per metà sul cielo trasparente (la carta, 1,33:1) e per metà sull'ulivo e sul muro bianco; abbassare la luce non bastava (il bianco reggeva solo con la foto al 50-70 %, cioè un velo, e il cielo restava carta). Quattro concetti provati sulla pagina vera e giudicati da tre lenti: vince «il cielo». La testa della ricerca sta nello spazio nel cielo (`.dt-testa_cielo`, prop `cielo` di PageHero), sulla carta, in inchiostro, fra i comandi e la villa che le sale sotto; il campo è «la domanda» (Playfair, segnaposto in corsivo pietra che si scrive da solo una volta, riga rossa del fuoco disegnata, pulsante tondo come punto fermo); i tre punti nel blocco sotto i comandi. Supera A48, A54 e A70 per la ricerca di /acquista. Le altre rotte con le scritte bianche sul cielo (stesso difetto) aspettano la scelta di Alberto fra inchiostro sulla carta e foto scurita («decido dopo»). |
