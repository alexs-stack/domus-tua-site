> **Superato il 2026-09-10.** Il redesign «rivista bianca» (spec `docs/superpowers/specs/2026-09-10-redesign-rivista-bianca-design.md`) ha smontato quasi tutto ciò che questo documento descrive: niente card, fiori né transizioni fra pagine, raggi a zero e nessuna sezione scura. Tre cose però non sono sparite. Qualche curva resta, fra le eccezioni elencate in `DESIGN.md` alla radice del repo: i bottoni-icona tondi e, nel preloader, la porta ad arco e il disco sotto il badge. Il pannello del preloader resta scuro (espresso), un'eccezione di lavoro che è ancora una domanda aperta. E da 1024 px, col movimento consentito, tre nastri pilotati dallo scroll tengono lo schermo sticky, senza il pin di GSAP: la rotaia del team, costruita col redesign, e i due set piece riportati l'11 settembre, «Perché Domus Tua» e le cinque stelle (`024d354`, che cita Alberto). **era-residence resta un riferimento vivo**, accanto a immobiliaregoldengoal.it, che è il riferimento visivo (la cliente, 2026-09-10). Di era-residence valgono le tecniche di movimento e di struttura che il codice porta (Alberto, 2026-09-11 e 2026-09-13): il preloader con la maschera ad arco e la sua timeline d'ingresso, il logo rotante, il reveal dei testi per righe, lo scroller orizzontale pilotato dallo scroll con le parallasse interne. Le sue cupole, i suoi fiori e le sue transizioni di pagina restano esclusi dalle direttive della cliente del 2026-09-10. **Le note su era-residence del §2.10 restano materiale di riferimento per la tecnica** dentro quel perimetro: ci sta il rail orizzontale, di cui `HorizonScroller.tsx` cita il dossier. Ne stanno fuori il bottone a due archi e il flip del tono del chrome (T1), e non valgono più la cupola e l'assegnazione degli effetti alle sezioni. Il sistema vivo è `DESIGN.md` alla radice del repo; il resto di questo documento resta come storia, non come guida.
...
> **Nota del 2026-09-13.** Le note su era-residence di questa scheda restano materiale di riferimento per la tecnica, ma solo dentro il perimetro in cui era-residence è un riferimento vivo (Alberto, 2026-09-11 e 2026-09-13): il preloader con la maschera ad arco e la sua timeline d'ingresso, il logo rotante, il reveal dei testi per righe, lo scroller orizzontale pilotato dallo scroll con le parallasse interne. Di questa scheda ci sta il rail orizzontale (effetto #9), che `HorizonScroller.tsx` porta nel codice citando il dossier. Ne stanno fuori il bottone a due archi (#6) e il flip del tono del chrome (T1); T1 oggi non avrebbe nemmeno oggetto, perché il sito ha un solo fondo avorio e `Cursor.tsx` e `ThreadNav` non esistono più. Cupole, fiori e transizioni di pagina restano esclusi dalle direttive della cliente del 2026-09-10. Le sezioni a cui qui sono assegnati gli effetti sono quelle di prima del redesign. Il sistema vivo è `DESIGN.md` alla radice del repo.
