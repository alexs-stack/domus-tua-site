...
| Foto di gruppo | `public/images/reali/team-group.jpg`, `team-trio.jpg`, `team-red.jpg` | Foto reale | 🔴 Da rifare | L'organico è cambiato: `team-group.jpg` ritrae sei persone (composizione precedente). Le foto restano in pagina, ma alt e didascalie non le descrivono più come "il team": sono "foto di gruppo". Servono nuove foto + liberatorie. |
