...
lockup «Domus Tua» (senza velo); nessuna scritta nera (`--color-ink` = grafite); tornano, nella
grammatica della rivista, i pannelli orizzontali di «Perché Domus Tua» e il film delle cinque
stelle. Il commit che li riporta (`024d354`) cita Alberto: «mantenendo quelle animazioni che non
erano curve». Le eccezioni ancora aperte alla grammatica, fra cui il pannello scuro del preloader e
le sue didascalie sotto i 16 px, sono nella spec `docs/superpowers/specs/2026-09-10-redesign-rivista-bianca-design.md`, §11.3 (domande 6 e 7).
